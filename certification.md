...
* Run a local web server with TLS support by default (add `--no-tls` to disable TLS) for development purposes with `symfony server:start`
...
### [New in PHP8.1](https://www.php.net/releases/8.1/en.php)
#### [Enumerations](https://www.php.net/releases/8.1/en.php#enumerations)
...
### [Symfony HttpClient component](https://symfony.com/doc/6.0/http_client.html)
...
[Upgrading existing project to use Symfony Flex](https://symfony.com/doc/6.0/setup/flex.html)
...
NOTE: The location of five directories (bin, config, public, src and var) can be customised by specifying a key/value pair in the *extra* section of composer.json, for example:
...
### [Components](https://symfony.com/doc/6.0/components/index.html)

If using Symfony components in non-Symfony projects: vendor/autoload.php must be included.

#### [Asset component](https://symfony.com/doc/6.0/components/asset.html)
...
A package facilitates:

* versioning
* allows a common base path to be set
* enables a CDN to be configured (if desired)
...
* read cookies
* make requests passing in a cookie jar
* navigate backwards and forwards through browser history
...
* [PSR-6 caching](https://symfony.com/doc/6.0/components/cache.html#cache-component-psr6-caching)
* [Cache contracts](https://symfony.com/doc/6.0/components/cache.html#cache-component-contracts) - this is the recommended approach
...
###### [Cache Adapters](https://symfony.com/doc/6.0/components/cache.html#available-cache-adapters)
* [APCu Cache Adapter](https://symfony.com/doc/6.0/components/cache/adapters/apcu_adapter.html)
* [Array Cache Adapter](https://symfony.com/doc/6.0/components/cache/adapters/array_cache_adapter.html)
* [Chain Cache Adapter](https://symfony.com/doc/6.0/components/cache/adapters/chain_adapter.html)
* [Doctrine Cache Adapter](https://symfony.com/doc/6.0/components/cache/adapters/doctrine_adapter.html)
* [Filesystem Cache Adapter](https://symfony.com/doc/6.0/components/cache/adapters/filesystem_adapter.html)
* [Memcached Cache Adapter](https://symfony.com/doc/6.0/components/cache/adapters/memcached_adapter.html)
* [PDO & Doctrine DBAL Cache Adapter](https://symfony.com/doc/6.0/components/cache/adapters/pdo_doctrine_dbal_adapter.html)
* [PHP Array Cache Adapter](https://symfony.com/doc/6.0/components/cache/adapters/php_array_cache_adapter.html)
* [PHP Files Cache Adapter](https://symfony.com/doc/6.0/components/cache/adapters/php_files_adapter.html)
* [Proxy Cache Adapter](https://symfony.com/doc/6.0/components/cache/adapters/proxy_adapter.html)
* [Redis Cache Adapter](https://symfony.com/doc/6.0/components/cache/adapters/redis_adapter.html)

##### [PSR-6 caching](https://symfony.com/doc/6.0/components/cache.html#basic-usage-psr-6)
...
* deleteItem() // Remove an item from cache by its key
...
[Cache Invalidation](https://symfony.com/doc/6.0/components/cache/cache_invalidation.html)

Two types of cache invalidation are available:
* [Tags-based invalidation](https://symfony.com/doc/6.0/components/cache/cache_invalidation.html#cache-component-tags)
* [Expiration based invalidation](https://symfony.com/doc/6.0/components/cache/cache_invalidation.html#cache-component-expiration), see [Cache item expiration](https://symfony.com/doc/6.0/components/cache/cache_items.html#cache-item-expiration)
...
##### [Defining and processing configuration values](https://symfony.com/doc/6.0/components/config/definition.html)
...
The config component also supports first-seen-wins/last-seen-wins strategies for configuration values (with `performNoDeepMerging()` and `cannotBeOverwritten()` methods) and also conditional validation of values: if key A is set, then key B must be set. These are called the [merging options](https://symfony.com/doc/current/components/config/definition.html#merging-options)
...
##### [Resources](https://symfony.com/doc/6.0/components/config/resources.html)
* [Locating resources](https://symfony.com/doc/6.0/components/config/resources.html#locating-resources)
* [Loading resources](https://symfony.com/doc/6.0/components/config/resources.html#resource-loaders)
* [Loader resolver](https://symfony.com/doc/6.0/components/config/resources.html#finding-the-right-loader)

This is all achieved with the [`Symfony\Component\Config\Definition\Builder\TreeBuilder`](https://symfony.com/doc/6.0/components/config/definition.html#defining-a-hierarchy-of-configuration-values-using-the-treebuilder) class.

[Node type](https://symfony.com/doc/6.0/components/config/definition.html#node-type)
...
[Expression syntax](https://symfony.com/doc/6.0/components/expression_language/syntax.html)

[Supported literals](https://symfony.com/doc/6.0/components/expression_language/syntax.html#supported-literals)
* strings
* numbers
* arrays
* hashes
...
Access to constant values is possible with the use of the constant() built in function, 'constant("PHP_VERSION")'... it's the only built in function but [custom functions can be registered and used](https://symfony.com/doc/6.0/components/expression_language/extending.html).

[Supported operators](https://symfony.com/doc/6.0/components/expression_language/syntax.html#supported-operators)
...
### [Backward compatibility promise](https://symfony.com/doc/6.0/contributing/code/bc.html)
...
- and `name` is a valid property, it's used (object property scope is respected - see [Visibility](https://www.php.net/manual/en/language.oop5.visibility.php))
...
`{{~ ~}}` // Removes whitespace before and after the variable (excluding newlines)
...
There's also the `\Twig\Loader\ArrayLoader` which is configured with template name array keys with the template being the array value.
...
#### [Overriding bundles](https://symfony.com/doc/6.0/bundles/override.html)
Templates can be overridden by copying them to `<your project>/templates/bundles/<bundle name>/`. Replicate the directory structure that is present in the bundle.
